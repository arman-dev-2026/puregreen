      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 w-full">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-100 mb-10 max-w-xl leading-relaxed font-sans font-light">
            Our contractors bring 18+ years of specialized industry experience from leading GC firms — delivering superior construction, renovation, and structural services across the GTA. Fully insured. Fully committed.
          </p>
          ...
          <div className="mt-10 flex flex-wrap gap-6 text-white/90 text-sm font-medium">
            <span className="flex items-center gap-2">
              <span className="w-1.5 h-1.5 bg-[#a7f3d0] rounded-full" /> 18+ Years Expertise
            </span>
            <span className="flex items-center gap-2">
